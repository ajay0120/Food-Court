...
import { Users, Heart, Award, Clock, ArrowLeft, Utensils, Target } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              ...
              behind this food ordering platform. This section will showcase our commitment to quality, 
              our culinary philosophy, and the values that drive us to serve you better.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-gray-700/30 rounded-xl p-4 border border-gray-600/30">
                ...
                <p className="text-sm text-gray-300">Our Mission</p>
                <p className="text-xs text-gray-500">Coming Soon</p>
              </div>
              <div className="bg-gray-700/30 rounded-xl p-4 border border-gray-600/30">
                <Utensils size={24} className="text-orange-400 mx-auto mb-2" />
                <p className="text-sm text-gray-300">Our Kitchen</p>
                <p className="text-xs text-gray-500">Coming Soon</p>
              </div>
              <div className="bg-gray-700/30 rounded-xl p-4 border border-gray-600/30">
                <Award size={24} className="text-orange-400 mx-auto mb-2" />
                <p className="text-sm text-gray-300">Our Values</p>
                <p className="text-xs text-gray-500">Coming Soon</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 text-orange-400">
              <Clock size={20} />
              <span className="font-medium">Content Development in Progress</span>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gray-800/50 rounded-full p-4 inline-block">
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span>Story Development in Progress</span>
